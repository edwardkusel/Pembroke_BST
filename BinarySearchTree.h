...
private:
        ...
        int max_helper(int one, int two) const;
        void insert_node_helper(Node *node, Node *parent, int value);
        bool remove_helper(Node *node, Node *parent);
        bool is_leaf(Node *node);
        bool delete_leaf(Node *node, Node *parent);
        bool is_one_child(Node *node);
        bool one_child_helper(Node *node, Node *parent);
        bool two_child_helper(Node *node);
};
